...
// Node definition for doubly circular linked list
class node
{
public:
    node* next;
...
// Class to manage Cinemax theater seat booking
class Cinemax
{
public:
    node* head, *tail, *temp;
    ...
    // Function to initialize the doubly circular linked list representing seats
    void create_list();

    // Function to display the current status of seats
    void display();
